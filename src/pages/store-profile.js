...
export default function StoreProfile() {
  ...
  const saveProfile = async () => {
    if (!storeName.trim()) { setMessage('Please enter your store name.'); return }
      ...
      <div style={styles.card}>
        ...
        {!editing ? (
          ...
          <div style={styles.editMode}>
            ...
            <button onClick={saveProfile} style={styles.saveBtn} disabled={saving}>
...
const styles = {
  page: { minHeight: '100vh', background: '#f8fafc', display: 'flex', justifyContent: 'center', padding: 24 },
  card: { background: '#fff', padding: 28, borderRadius: 14, maxWidth: 460, width: '100%', boxShadow: '0 10px 30px rgba(0,0,0,0.08)', height: 'fit-content' },
  ...
  gpsBtn: { width: '100%', padding: 12, background: '#0f172a', color: 'white', border: 'none', borderRadius: 8, cursor: 'pointer', fontSize: 14, fontWeight: 600, marginTop: 4 },
  ...
  saveBtn: { marginTop: 16, width: '100%', padding: 12, background: '#2563eb', color: 'white', border: 'none', borderRadius: 8, fontSize: 15, fontWeight: 600, cursor: 'pointer' },
  cancelBtn: { marginTop: 8, width: '100%', padding: 12, background: '#f1f5f9', color: '#475569', border: 'none', borderRadius: 8, fontSize: 15, cursor: 'pointer' },
  mapsBtn: { padding: '10px 14px', background: '#eff6ff', color: '#2563eb', border: '1px solid #bfdbfe', borderRadius: 8, cursor: 'pointer', fontSize: 14, fontWeight: 600, width: '100%', marginBottom: 4, marginTop: 8 },
  editBtn: { marginTop: 12, width: '100%', padding: 12, background: '#2563eb', color: 'white', border: 'none', borderRadius: 8, fontSize: 15, fontWeight: 600, cursor: 'pointer' },
